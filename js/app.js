...
if ( seg == 0)  {
  ...
  animacionTitulo: function(){
    setInterval(function(){
      $(".main-titulo").switchClass("main-titulo","main-titulo2", 200),
      $(".main-titulo2").switchClass("main-titulo2","main-titulo", 200)
    }, 1000);
  },
  imagenes: function(){
    var i = 0;
  ...
  scanRepetidosCol: function(){
    ...
    for(var i = 0; i < col.total; i++){
      for(var img = 0; img < imagen.total; img++){
        if($(col[i][0]).attr("src") == imagen[img] && $(col[i][1]).attr("src") == imagen[img] && $(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img] && $(col[i][6]).attr("src") == imagen[img]){

          puntuacion = puntuacion + 7;
          item = {arrays: [0,1,2,3,4,5,6], colFil: colDiv[i], obj: objeto, item: i, puntos: puntuacion};
          data.push(item);

        }else if($(col[i][1]).attr("src") == imagen[img] && $(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img] && $(col[i][6]).attr("src") == imagen[img]){

          puntuacion = puntuacion + 6;
          item = {arrays: [1,2,3,4,5,6], colFil: colDiv[i], obj: objeto, item: i, puntos: puntuacion};
          data.push(item);

        }else if($(col[i][0]).attr("src") == imagen[img] && $(col[i][1]).attr("src") == imagen[img] && $(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img]){
        ...
        }else if($(col[i][0]).attr("src") == imagen[img] && $(col[i][1]).attr("src") == imagen[img] && $(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img]){

          puntuacion = puntuacion + 5;
          item = {arrays: [0,1,2,3,4], colFil: colDiv[i], obj: objeto, item: i, puntos: puntuacion};
          data.push(item);

        }else if($(col[i][1]).attr("src") == imagen[img] && $(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img]){

          puntuacion = puntuacion + 5;
          item = {arrays: [1,2,3,4,5], colFil: colDiv[i], obj: objeto, item: i, puntos: puntuacion};
          data.push(item);

        }else if($(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img] && $(col[i][6]).attr("src") == imagen[img]){
        ...
        }else if($(col[i][2]).attr("src") == imagen[img] && $(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img]){

          puntuacion = puntuacion + 4;
          item = {arrays: [2,3,4,5], colFil: colDiv[i], obj: objeto, item: i, puntos: puntuacion};
          data.push(item);

        }else if($(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img] && $(col[i][6]).attr("src") == imagen[img]){
        ...
        }else if($(col[i][3]).attr("src") == imagen[img] && $(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img]){

          puntuacion = puntuacion + 3;
          item = {arrays: [3,4,5], colFil: colDiv[i], obj: objeto, item: i, puntos: puntuacion};
          data.push(item);

        }else if($(col[i][4]).attr("src") == imagen[img] && $(col[i][5]).attr("src") == imagen[img] && $(col[i][6]).attr("src") == imagen[img]){
